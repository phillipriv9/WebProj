...
This is a just an example and sample of my work process in R, and how I typically work with data. This is the same process that will be applied to Blue Nitrogen Project (Minus data set generation). 
