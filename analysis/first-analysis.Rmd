...
ggplot(mean_cover, aes(x = Species, y = mean_cover, fill = Species)) +
  ...
  labs(title = "Mean Cover of Plant Species in Texas Salt Marsh",
       ...
       y = "Mean Cover",
       fill = "Species") +
  guides(fill = guide_legend(title = "Species", override.aes = list(fill = "skyblue"))) +
  theme(legend.position = "bottom") +
  scale_fill_manual(values = c("skyblue", "skyblue", "skyblue", "skyblue", "skyblue"))  # Set fill colors manually
